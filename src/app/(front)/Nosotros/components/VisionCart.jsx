...
const VisionCart = ({ setShowModal2 }) => {
    ...
    return (
        ...
        >
            <h1 className="text-3xl text-center   px-4  md:px-52 md:text-6xl md:font-medium text-[#292930]">
                Los ejes fundamentales de nuestra visión.
            </h1>
            <div className="flex justify-center">
                <div className="grid grid-cols-1 sm:grid-cols-2 xs:px-8  md:grid-cols-4 gap-8 md:max-w-[100rem]">

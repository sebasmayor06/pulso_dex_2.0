...
export default function PoliticasPage() {
  ...
  return (
    <div ref={ref} className={`overflow-x-hidden shadow-xl bg-azulInicio ${style.bg2}`}>
      <div className={`flex justify-center items-center w-screen h-screen overflow-hidden left-0 bg-inherit`}>
       
        <div className='flex flex-col gap-5'>
        <h1 className={` xs:title-primary  animate-fade-right ${inView?'animate-once animate-duration-500 animate-ease-in':''}`}>

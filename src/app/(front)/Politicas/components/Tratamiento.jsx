  ...
  return (
    <div className="politica-container">
      <div className="politica-container_children">
        ...
        <div>
          <p>
            Tipos de datos recogidos En la medida de lo posible, Interface
        ...
        <div>
          <h3> Cómo y por qué utilizamos sus datos personales</h3>
          <p>
          ...
          <p>
            ...
            siguiente dirección: ayuda@pulsodex.com.co; Utilizamos los datos que

...
const CardSideNav = () => {
  ...
  return (
    <section className="   h-full  ">
      <div
        className="w-80  bg-white flex flex-col gap-10  transition-all duration-200 ease-out h-full fixed md:block lg:block z-30 pr-3"
      ...
      <button onClick={handleClose} className="pt-9 pl-3 text-black z-50">
        <div
